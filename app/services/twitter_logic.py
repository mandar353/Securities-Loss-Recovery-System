...
#     # Loss logic
#     if sale_date and sale_date <= DISCLOSURE_DATE:
#         loss = max(0, purchase_price - sale_price) * quantity
#         loss_type = "Pre-disclosure sale"
#     else:
#         # simulate price drop impact
#         adjusted_price = sale_price * 0.9
#         loss = max(0, purchase_price - adjusted_price) * quantity
#         loss_type = "Post-disclosure adjustment"
